...
-- Last modification date: 2022-02-15 08:10:52.415
...
-- foreign keys
-- Reference: kontaktandmed_isikuandmed (table: patient_contact_info)
ALTER TABLE patient_contact_info ADD CONSTRAINT kontaktandmed_isikuandmed
